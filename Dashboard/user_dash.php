...
<div class="class mt-20 m-10 rounded-sm">
    <div class="relative flex justify-center bg-blue-300">
        <div class="m-32 text-center">
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">
            "Every<mark class="px-2 text-white bg-blue-600 m-5 rounded">Photo</mark>Has A Story"
            </h1>
            <p class="text-lg font-normal text-gray-500 lg:text-xl">
            Let's make your story come true through the touch of E-Photo.
            </p>
        </div>
    </div>
</div>
...
<div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8">
    <h5 class="mb-2 text-3xl font-bold text-gray-900">E-Photo Mobile App</h5>
    <p class="mb-5 text-base text-gray-500 sm:text-lg">Download The Application Now</p>
